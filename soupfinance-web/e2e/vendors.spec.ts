...
test.describe('Vendor Management', () => {
  ...
  async function mockVendorsApi(
    ...
    await page.route('**/vendor/save*', (route) => {
      route.fulfill({
        status: 200,
        contentType: 'application/json',
        body: JSON.stringify({
    ...
    await page.route('**/vendor/update/*', (route) => {
      const url = route.request().url();
    ...
    await page.route('**/vendor/delete/*', (route) => {
      route.fulfill({
        status: 200,
        contentType: 'application/json',
  ...
  test.describe('Vendor List Page', () => {
    ...
    test('shows loading state while fetching', async ({ page }) => {
      ...
      await page.route('**/vendor/index.json*', async (route) => {
